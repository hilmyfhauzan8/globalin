...
if (isset($_POST['simpan_semua'])) {
    ...
    header("Location: absensi_baru.php?id_kelas=$id_kelas&status=sukses-absen");
    exit;
}
...
<head>
    <meta charset="UTF-8">
    <title>Bulk Absensi - Globalin Academy</title>
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-primary fw-bold">SISTEM ABSENSI MASSAL</h2>
